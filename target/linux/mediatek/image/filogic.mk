...
define Device/jrouter_ax6000-v1
  DEVICE_VENDOR := JRouter
  DEVICE_MODEL := AX6000
  DEVICE_VARIANT := V1
  DEVICE_DTS := mt7986a-jrouter-ax6000-v1
  DEVICE_DTS_DIR := ../dts
...
ifneq ($(CONFIG_TARGET_ROOTFS_INITRAMFS),)
  ...
  IMAGE/sysupgrade.bin := sysupgrade-tar | append-metadata
endef
TARGET_DEVICES += jrouter_ax6000-v1

define Device/jrouter_ax6000-v2
  DEVICE_VENDOR := JRouter
  DEVICE_MODEL := AX6000
  DEVICE_VARIANT := V2
  DEVICE_DTS := mt7986a-jrouter-ax6000-v2
  DEVICE_DTS_DIR := ../dts
  DEVICE_PACKAGES := kmod-usb3 kmod-usb2 kmod-mt7915e kmod-mt7916-firmware kmod-mt7986-firmware mt7986-wo-firmware
  UBINIZE_OPTS := -E 5
  UBOOTENV_IN_UBI := 1
...
ifneq ($(CONFIG_TARGET_ROOTFS_INITRAMFS),)
  ...
  IMAGE/sysupgrade.bin := sysupgrade-tar | append-metadata
endef
TARGET_DEVICES += jrouter_ax6000-v2
